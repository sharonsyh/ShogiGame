[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-24ddc0f5d75046c5622901739e7c5dd533143b0c8e959d652212380cedb1ea36.svg)](https://classroom.github.com/a/MCrIWe9U)
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=14480766&assignment_repo_type=AssignmentRepo)
...
You can work on this project locally on your desktop or online on GitHub's in-browser VSCode. **No matter what option you choose, please ensure you are using Node `12.16.1` when developing your code**
...
```
$ git clone https://github.com/Box-Internship-Assignment/box-take-home-javascript-<your-github-username>.git
```
...
For example, using the `diff` tool on a Node solution:

```
$ node index.js -f ./test_cases/initialMove.in | diff -u ./test_cases/initialMove.out -
```
